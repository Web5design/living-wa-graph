app.directive('circleMarkers', function ($log, $rootScope, $q, leafletData, leafletHelpers, leafletMapDefaults, leafletCircleMarkersHelpers, leafletEvents) {
    return {
        restrict: "A",
        scope: false,
        replace: false,
        ...
        link: function(scope, element, attrs, controller) {
            var mapController = controller[0],
                ...
                markers = leafletScope.circleMarkers,
                deleteMarker = leafletCircleMarkersHelpers.deleteMarker,
                addMarkerWatcher = leafletCircleMarkersHelpers.addMarkerWatcher,
                listenMarkerEvents = leafletCircleMarkersHelpers.listenMarkerEvents,
                addMarkerToGroup = leafletCircleMarkersHelpers.addMarkerToGroup,
                bindMarkerEvents = leafletEvents.bindMarkerEvents,
                createMarker = leafletCircleMarkersHelpers.createMarker;
            ...
            mapController.getMap().then(function(map) {
                ...
                getLayers().then(function(layers) {
                    ...
                    leafletScope.$watch('circleMarkers', function(newMarkers) {
