app.directive('geojson', function ($log, $rootScope, leafletData, leafletHelpers) {
    return {
        restrict: "A",
        scope: false,
        replace: false,
                    ...
                    if (!onEachFeature) {
                        onEachFeature = function(feature, layer) {
                            ...
                            layer.on({
                                ...
                                // SOCRATA: giacomo.ferrari@socrata.com: Adapting this workaround for double click on geoJSON
                                // feature not propagating through to leaflet.
                                // https://groups.google.com/forum/#!topic/leaflet-js/UxxYGezokoA
                                dblclick: function(e) {
